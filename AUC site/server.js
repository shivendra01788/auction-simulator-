...
// Tournament Configuration (in Crores)
...
// Clean precision helper for floating-point arithmetic in Crores
...
function calculateFinalStandings(room) {
    ...
    for (let key in room.teams) {
        ...
        const purseBonus = Math.floor(team.purse); // 1 pt per 1 Cr saved
